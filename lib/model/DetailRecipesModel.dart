...
DetailRecipesModel detailRecipesModelFromJson(String str) => DetailRecipesModel.fromJson(json.decode(str));

String detailRecipesModelToJson(DetailRecipesModel data) => json.encode(data.toJson());

class DetailRecipesModel {
  DetailRecipesModel({
    this.method,
    this.status,
    this.results,
  ...
  factory DetailRecipesModel.fromJson(Map<String, dynamic> json) => DetailRecipesModel(
    method: json["method"],
    status: json["status"],
